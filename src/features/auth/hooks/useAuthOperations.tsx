...
export const useAuthOperations = (
  ...
  const signIn = async (email: string, password: string): Promise<boolean> => {
    ...
    try {
      ...
      if (isPreviewEnvironment() && setMockUser) {
        console.log(
          "[Auth Debug] Preview environment detected, checking for mock auth"
        );
  ...
  const signUp = async (
    ...
    try {
      ...
      if (isPreviewEnvironment() && setMockUser) {
        console.log(
          "[Auth Debug] Preview environment detected, creating mock user"
        );
  ...
  const resetPassword = async (email: string): Promise<boolean> => {
    ...
    try {
      ...
      if (isPreviewEnvironment()) {
        console.log(
          "[Auth Debug] Preview environment detected, simulating password reset"
        );
  ...
  const updatePassword = async (newPassword: string): Promise<boolean> => {
    ...
    try {
      ...
      if (isPreviewEnvironment()) {
        console.log(
          "[Auth Debug] Preview environment detected, simulating password update"
        );
  ...
  const updateEmail = async (newEmail: string): Promise<boolean> => {
    ...
    try {
      ...
      if (isPreviewEnvironment() && setMockUser) {
        console.log(
          "[Auth Debug] Preview environment detected, updating mock user email"
        );
