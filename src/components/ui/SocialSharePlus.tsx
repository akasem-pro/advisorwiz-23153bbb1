...
import { Share2, Facebook, Twitter, Linkedin, Mail, Link as LinkIcon, Download, ArrowRight } from 'lucide-react';
...
const SocialSharePlus: React.FC<SocialSharePlusProps> = ({
  ...
  // Horizontal layout - icons with text in a row
  ...
  // Cards variant - each platform as a card
  if (variant === 'cards') {
    return (
      <div className={`${className}`}>
        <Card>
