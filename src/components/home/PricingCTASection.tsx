...
const PricingCTASection: React.FC = () => {
  return (
    <section className="py-12 bg-slate-100 dark:bg-navy-900" aria-labelledby="pricing-cta-heading">
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <Button asChild className="bg-teal-600 hover:bg-teal-700 dark:bg-teal-600 dark:hover:bg-teal-700 text-white">
            <Link to="/pricing">
