    ...
    <section className="py-16 bg-white" aria-labelledby="testimonials-heading">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 id="testimonials-heading" className="text-3xl font-serif font-bold text-navy-900 mb-4">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {testimonials.map((testimonial) => (
            <div 
              key={testimonial.id} 
              className="bg-slate-50 p-6 md:p-8 rounded-xl shadow-sm border border-slate-100 hover:shadow-md transition-shadow"
            >
              ...
              <blockquote className="mb-6">
                ...
                <footer className="flex items-center">
                  <div className="w-10 h-10 rounded-full bg-navy-200 flex items-center justify-center text-white font-medium mr-3">
                    {testimonial.image ? (
                      <img 
                  ...
                  <div>
                    <cite className="font-medium text-navy-900 not-italic block">
                      {testimonial.author}
                    </cite>
