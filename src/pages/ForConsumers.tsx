      ...
      <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-grow pt-20">
          ...
          <section className="py-16 bg-navy-50" aria-labelledby="journey-heading">
            <div className="container mx-auto px-4">
              <h2 id="journey-heading" className="text-3xl font-serif font-bold text-center text-navy-900 mb-12">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <div className="bg-white rounded-xl p-6 shadow-sm">
                  ...
                  <p className="text-slate-600">Get matched with advisors based on your specific financial goals, investment preferences, and communication style.</p>
                </div>
                ...
                <div className="bg-white rounded-xl p-6 shadow-sm">
                  ...
                  <p className="text-slate-600">Connect with pre-vetted, qualified financial advisors with verified credentials and regulatory standing.</p>
                </div>
                ...
                <div className="bg-white rounded-xl p-6 shadow-sm">
                  ...
                  <p className="text-slate-600">Communicate safely and securely within our protected platform before deciding to work together.</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="py-16 bg-white" aria-labelledby="benefits-heading">
            <div className="container mx-auto px-4">
              <h2 id="benefits-heading" className="text-3xl font-serif font-bold text-center text-navy-900 mb-12">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="bg-slate-50 rounded-xl p-6">
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="text-xl font-bold text-navy-800">Quality Matches</h3>
                  </div>
                ...
                <div className="bg-slate-50 rounded-xl p-6">
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="text-xl font-bold text-navy-800">No Pressure</h3>
                  </div>
                  <p className="text-slate-600">
                ...
                <div className="bg-slate-50 rounded-xl p-6">
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="text-xl font-bold text-navy-800">Complete Privacy</h3>
                  </div>
                  <p className="text-slate-600">
                ...
                <div className="bg-slate-50 rounded-xl p-6">
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="text-xl font-bold text-navy-800">Always Free</h3>
                  </div>
                  <p className="text-slate-600">
