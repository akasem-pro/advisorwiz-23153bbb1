...
const Analytics: React.FC = () => {
  ...
  return (
    <PageSEO
      title="Analytics Dashboard | AdvisorWiz"
      description="Track your performance metrics and client engagement with our comprehensive analytics dashboard."
      canonicalUrl="/analytics"
    >
      <PageTransition animation="fade">
        <DashboardLayout 
          title="Analytics Dashboard" 
          subtitle="Track your performance and client engagement"
