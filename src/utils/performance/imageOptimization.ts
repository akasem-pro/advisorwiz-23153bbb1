` in the code, which isn't valid TypeScript.

Let me fix these issues:

<lov-code>
I need to clean up the performanceTracking.ts file by removing the embedded `<lov-write>` tag and all the duplicate code that's causing the issues:

<lov-write file_path="src/utils/performanceTracking.ts">
